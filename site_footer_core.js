(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      ".tf-site-footer__link:focus-visible,.tf-site-footer__cta:focus-visible{outline:3px solid #facc15;outline-offset:4px}",
      ...
      ".tf-site-footer__bottom{display:flex;align-items:center;justify-content:space-between;gap:18px;margin-top:36px;padding-top:20px;border-top:1px solid rgba(148,163,184,.15)}",
      ".tf-site-footer__bottom p{margin:0;color:#8290a8;font-size:12px;line-height:1.5}",
