(function () {
  ...
  function installStyles() {
    ...
    style.textContent = [
      ...
      "  color: #e2e8f0;",
      "  background: linear-gradient(145deg, #070d1c 0%, #111b38 58%, #172554 100%);",
      ...
      "  display: grid;",
      "  grid-template-columns: minmax(0, 1.35fr) minmax(180px, 0.8fr) minmax(240px, 0.95fr);",
      "  gap: clamp(30px, 5vw, 72px);",
      "  align-items: start;",
      "}",
      ".tf-site-footer__eyebrow {",
      "  display: inline-flex;",
      "  align-items: center;",
      "  gap: 9px;",
      "  margin: 0 0 16px;",
      ...
      "}",
      ".tf-site-footer__eyebrow::before {",
      "  content: \"\";",
      "  width: 26px;",
      "  height: 2px;",
      "  border-radius: 99px;",
      ...
      "  line-height: 1.7;",
      "}",
      ".tf-site-footer__credentials {",
      "  display: grid;",
      "  grid-template-columns: repeat(3, minmax(0, 1fr));",
      "  gap: 10px;",
      "  margin-top: 24px;",
      "}",
      ".tf-site-footer__credential {",
      "  min-height: 92px;",
      "  padding: 15px 13px;",
      ...
      "}",
      ".tf-site-footer__credential strong {",
      "  display: block;",
      "  margin-bottom: 7px;",
      "  color: #a5b4fc;",
      "  font-size: 18px;",
      "  line-height: 1;",
      "}",
      ".tf-site-footer__credential span {",
      "  display: block;",
      "  color: #dbe4f3;",
      "  font-size: 12px;",
      "  font-weight: 650;",
      ...
      "  text-transform: uppercase;",
      "}",
      ".tf-site-footer__links {",
      "  display: grid;",
      "  gap: 12px;",
      "}",
      ".tf-site-footer__link {",
      "  width: fit-content;",
      "  color: #cbd5e1;",
      "  font-size: 14px;",
      "  font-weight: 650;",
      ...
      "}",
      ".tf-site-footer__link:hover { color: #ffffff; transform: translateX(3px); }",
      ".tf-site-footer__link:focus-visible, .tf-site-footer__cta:focus-visible {",
      ...
      "}",
      ".tf-site-footer__cta:hover {",
      "  transform: translateY(-2px);",
      "  box-shadow: 0 16px 34px rgba(21, 128, 61, 0.34);",
      "}",
      ...
      "}",
      ".tf-site-footer__bottom p {",
      "  margin: 0;",
      "  color: #8290a8;",
      "  font-size: 12px;",
      "  line-height: 1.5;",
      "}",
      ".tf-site-footer__bottom a { color: #a5b4fc; text-decoration: none; }",
      ".tf-site-footer__bottom a:hover { color: #ffffff; text-decoration: underline; }",
      "@media (max-width: 850px) {",
      "  .tf-site-footer__grid { grid-template-columns: 1fr 1fr; }",
      "  .tf-site-footer__brand { grid-column: 1 / -1; }",
      "}",
      "@media (max-width: 620px) {",
      "  .tf-site-footer__inner { width: min(100% - 28px, 1120px); padding-top: 40px; }",
      "  .tf-site-footer__grid { grid-template-columns: 1fr; gap: 30px; }",
      "  .tf-site-footer__brand { grid-column: auto; }",
      "  .tf-site-footer__credentials { grid-template-columns: 1fr; }",
      "  .tf-site-footer__credential { min-height: auto; }",
      "  .tf-site-footer__bottom { align-items: flex-start; flex-direction: column; }",
      "}",
      "@media (prefers-reduced-motion: reduce) {",
      "  .tf-site-footer__link, .tf-site-footer__cta { transition: none; }",
      "}",
      "@media print {",
      "  .tf-site-footer { color: #111827; background: #ffffff; border-top: 1px solid #cbd5e1; box-shadow: none; }",
      "  .tf-site-footer__title, .tf-site-footer__heading { color: #111827; }",
      "  .tf-site-footer__description, .tf-site-footer__link, .tf-site-footer__contact p, .tf-site-footer__credential span { color: #334155; }",
      "}",
    ].join("\n");
  ...
  function buildFooter() {
    ...
    footer.innerHTML = [
      ...
      '      <p class="tf-site-footer__eyebrow">Ensino com formação e experiência</p>',
      '      <h2 class="tf-site-footer__title" id="tf-footer-title">Teacher Flávio</h2>',
      '      <p class="tf-site-footer__description">Aulas de inglês online e ao vivo, com acompanhamento próximo, método claro e prática constante.</p>',
      ...
      '      <a class="tf-site-footer__cta" href="https://wa.me/5534998349756?text=Teacher%2C%20quero%20marcar%20uma%20aula%20experimental%20gratuita" target="_blank" rel="noopener noreferrer">Conversar no WhatsApp</a>',
      '    </section>',
      '  </div>',
      '  <div class="tf-site-footer__bottom">',
      '    <p>&copy; <span data-tf-footer-year></span> Teacher Flávio. Todos os direitos reservados.</p>',
      '    <p>Flávio de Sousa Freitas · Bacharel em Tradução, Mestre e Doutor em Linguística.</p>',
      '  </div>',
      '</div>',
    ].join("");
